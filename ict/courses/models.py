...
class AdmissionForm(models.Model):
    ...
    student_name_ban=models.CharField('Student name:', max_length=150)
    student_name_eng=models.CharField('', max_length=150)
    father_or_hus_name_ban=models.CharField('Father/Husband name:',max_length=150)
    father_or_hus_name_eng=models.CharField('', max_length=150)
    village_ban=models.CharField('Village:',max_length=100)
    village_eng=models.CharField('', max_length=100)
    post_office_ban=models.CharField('Post office:', max_length=100)
    post_office_eng=models.CharField('', max_length=100)
    upozila_ban=models.CharField('Upazilla:', max_length=100)
    upozila_eng=models.CharField('', max_length=100)
    district_ban=models.CharField('District:', max_length=100)
    ...
    nid=models.IntegerField('National ID no.:', null=False)
    ...
    pharmacy_name_address=models.CharField('Pharmacy name and address:', max_length=255)
